...
import Network.HTTP.Req ((/:), defaultHttpConfig, https, jsonResponse, req, responseBody, runReq)
...
sendLetter authEmail key apiMode letter = do
  runReq defaultHttpConfig $ do
    ...
    r <- req Req.POST endpoint (Req.ReqBodyJson payload) jsonResponse mempty
